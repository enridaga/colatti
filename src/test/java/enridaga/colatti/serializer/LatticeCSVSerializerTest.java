...
public class LatticeCSVSerializerTest {
	private final static Logger log = LoggerFactory.getLogger(LatticeCSVSerializerTest.class);
	...
	public void test() throws ColattiException{
		...
		CSVSerializer ser = new CSVSerializer(System.err);
